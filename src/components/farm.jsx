        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8">
          <div>
            ...
            <p className="indent-30 mb-4">
              Наша ферма пропонує якісне м’ясо перепелів, вирощених у
              натуральних умовах. Техаський білий бройлерний перепел відомий
              своїм великим розміром і ніжним м’&apos;ясом, багатим на білок,
              залізо та інші корисні речовини. Це ідеальний продукт для
              здорового харчування, який легко засвоюється та підходить навіть
